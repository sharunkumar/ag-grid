export const ADVANCED_FILTER_LOCALE_TEXT = {
    ...
    ariaAdvancedFilterBuilderColumn: 'Column<any>',
    ...
    advancedFilterValidationMissingColumn: 'Column<any> is missing',
    advancedFilterValidationMissingOption: 'Option is missing',
    advancedFilterValidationMissingValue: 'Value is missing',
    advancedFilterValidationInvalidColumn: 'Column<any> not found',
