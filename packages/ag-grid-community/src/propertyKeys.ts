...
type GridOptionKey = keyof GridOptions<any>;
...
export type AnyGridOptions = {
    [K in keyof GridOptions<any>]: GridOptions<any>[K] extends 'NO_MATCH' ? K : never;
}[keyof GridOptions<any>];

/**
 * Get all the GridOptions properties of the provided type.
 * Will also include `any` properties.
 */
type KeysLike<U> = Exclude<GetPropKeys<GridOptions<any>, U>, undefined>;
/**
 * Get all the GridOption properties that strictly contain the provided type.
 * Does not include `any` properties.
 */
type KeysWithType<U> = Exclude<GetPropKeys<GridOptions<any>, U>, AnyGridOptions>;
